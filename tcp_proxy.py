...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    # receive data from remote host if necessary
    if receive_first:
        ...
        # if we have data, lets go ahead and send
...
def receive_from(connection):
    ...
    # set a two second time out that can be adjusted.
...
# request handler to modify requests
...
def main():
    ...
    if len(sys.argv[1:]) != 5:
        ...
        print "Example: ./tcp_proxy.py 127.0.0.1 9000 192.168.1.3 9000 True"
        sys.exit(0)
    ...
    # spin up local listening socket
